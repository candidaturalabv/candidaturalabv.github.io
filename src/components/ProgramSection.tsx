...
const fullProgram: ProgramBlock[] = [
  ...
  },
  {
    ...
    content: {
      ...
      eu: [
        ...
        '**5. Staff-eko karrera profesionalen definizioa eta garapena**',
        'Vicomtechen hazkundea bereziki nabarmena izan da kudeaketaren eta laguntza sailetan (Staff), baina hazkunde horrekin batera ez da rolen eta etorkizun profesionalaren definizio argirik eman.',
        'Funtzio eta Erantzukizunen Eskuliburua: Zehaztugabetasunarekin amaitu behar da. Staffeko lanpostu bakoitzaren funtzioak modu argian dokumentatzea proposatzen dugu, gerora sortutako zereginak bere gain hartzea saihesteko eta profesional bakoitzak bere roletik zer espero den jakingo duela ziurtatzeko.',
        'Karrera Profesional Espezifiko baten diseinua: Nahiz eta ikertzaileak bezala, kategoria jakin bati (S) lotuta dauden, Staffeko langileek progresio profesionalaren ikusgarritasuna izan behar dute, sustapen-irizpide gardenak eta esperientziari eta etengabeko prestakuntzari lotuak.',
        '**6. Prestakuntzarako eta "I+G Pertsonalerako" denbora**',
      ...
      en: [
        ...
        '**5. Definition and Development of Professional Careers in Staff**',
        'Vicomtech\'s growth has been particularly notable in the areas of management and support (Staff), but this growth has not been accompanied by a clear definition of their roles and professional future.',
        'Job Description and Responsibilities Manual: It is necessary to put an end to this lack of definition. We propose clearly documenting the duties of each staff position to avoid the assumption of unexpected tasks and ensure that each professional knows what is expected of their role.',
        'Design of a Specific Professional Career: Although, like researchers, they are associated with a specific category (S), staff members must have a career progression path, with transparent promotion criteria linked to experience and continuous training.',
        '**6. Time for Training and \'Personal R&D\'**',
  ...
  },
  {
    title: {
      ...
      eu: 'Malgutasuna eta Kontziliazioa atala',
    ...
    content: {
      ...
      eu: [
        '**Bizitza pertsonala errespetatzen duen lan-ingurune baterantz**',
        'Vicomtech erreferentziazko zentroa izaten jarraitzeko, profesional onenak erakartzeko eta gurekin hurbil mantentzeko ingurune egokia eskaini behar dugu. Malgutasuna ez da eskubide huts bat, ongizatea eta produktibitatea bultzatzen dituen lehiarako abantaila baizik.',
        '**1. Telelana ongizatearen eta lehiakortasunaren eragile**',
        'Urruneko lanari leku handiagoa emango dion eredu baterantz goaz. Helburua garbia da: kontziliazioa hobetzea eta gurea bezalako sektore bizi batean talentua erakartzea.',
        'Zentroarentzat kosturik gabeko 6 egun izatea: Telelaneko hileko egunak 4tik 6ra handitzea proposatzen dugu. Inplementazio errazeko eta zero kostuko neurria da Vicomtechentzat, % 30eko lege-marjinaren barruan mantentzen baita (10/2021 Legea), karga gehigarriak saihestuz plantillaren bizi-kalitatea nabarmen hobetzen den bitartean. Malgutasun hori dagoeneko arrakastaz aplikatzen duten gure inguruko beste zentru batzuetako praktikekin bat egingo genuke.',
        'Staff-eko langileentzako telelanaren ebaluazioa: Staff-en zereginen azterketa teknikoa eskatzen dugu urruneko zer funtzio egin daitezkeen identifikatzeko. Helburua da telelanaren eredu bat balioestea, profesional horien bizi-kalitatea hobetzeko, ikerketa-sailei ematen zaien zerbitzua konprometitu gabe. Sailaren eta eginkizunen arabera, txanda-sistema bat ezar liteke, zenbait zereginetarako zentroan beti pertsonaren bat egongo dela bermatzeko.',
      ...
      en: [
        ...
        'Evaluation of teleworking for staff: We request a technical analysis of staff tasks to identify which functions can be performed remotely. The aim is to evaluate a teleworking model that improves the quality of life of these professionals without compromising the service provided to the research departments. Depending on the department and the roles, a shift system could be established to ensure that there is always someone available at the centre for certain functions.',
