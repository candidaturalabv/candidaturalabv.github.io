...
export const translations = {
  ...
  hero: {
    ...
    tagline: {
      ...
      eu: "Kexa gutxiago kafean, eta konponbide gehiago elkarrekin.",
      en: "Fewer complaints during coffee breaks and more solutions at the table.",
    },
  },
  about: {
    title: { es: "QUIÉNES SOMOS", eu: "VICOMTECH GARA", en: "WE ARE VICOMTECH" },
    description: {
      ...
      eu: "Vicomtecheko langileak gara, batzuk duela ia hogei urte. Egunero officean eta autobusean ikusten duzun jendea gara. Vicomtech-en dibisio guztietatik gatoz, erakundearen ordezkaritza anitza osatzen dugu. Zure egunerokotasuna ezagutzen dugu eta zure kezkak eta zalantzak partekatzen ditugu.",
      en: "We are Vicomtech employees, some of us for almost twenty years. We are the people you meet every day in the office and on the bus. From all divisions of Vicomtech, we form a diverse representation of the organization. We understand your day-to-day life and share your concerns and worries.",
    },
    initiative: {
      ...
      eu: "Langile-batzordea sortzeko hauteskundeak bultzatzeko ideia lankide talde honetako hainbat pertsonek, beste lankide batzuekin batera, sustatutako ekimen batetik sortu zen. Ekimen horri esker, lan-hitzarmeneko lanaldia eta atseden-egunak berrikusi egin ziren, eta gaur egun 15 minutuko murrizketa dugu eguneroko lanaldian, eta baita days off egun bat gehiago ere. Esperientzia horretatik abiatuta, argi ikusi genuen langileen batzorde bat izatea indarrak batu eta espazio komun bat izateko modu eraginkorra dela, gai hauek —eta etorkizunean sor daitezkeen beste asko— modu kolektibo, hurbil eta irekian jorratzeko.",
      en: "The idea to promote these works council elections arose from an initiative by several people in this group, together with other colleagues, which led to a review of the working hours and days off in the collective agreement. As a result, we now have a 15-minute reduction in the working day and an extra days off. From that experience, we realized that having a workers' committee is a good way to join forces and have a common space to address these types of issues—and others that may arise in the future—collectively, closely, and through dialogue.",
    },
  },
  concerns: {
    ...
    items: [
      ...
      { es: "Más teletrabajo", eu: "Telelan gehiago", en: "More teleworking" },
      { es: "Vacaciones flexibles", eu: "Opor malgutasuna", en: "Flexible vacations" },
      { es: "Viajes y dietas", eu: "Bidaiak eta dietak", en: "Travel and allowances" },
      { es: "Conciliación real", eu: "Kontziliazio erreala", en: "Real work-life balance" },
      { es: "Traslado a MUBIL", eu: "MUBILera lekualdatzea", en: "Transfer to MUBIL" },
    ],
    more: {
      es: "... y muchos más temas que podemos trabajar juntos!",
      eu: "... eta elkarrekin landu ditzakegun askoz gai gehiago.",
      en: "...and many more issues we can work on together.",
    },
  },
  advisory: {
    title: { es: "ASESORAMIENTO INDEPENDIENTE", eu: "AHOLKULARITZA INDEPENDENTEA", en: "INDEPENDENT ADVICE" },
    description: {
      ...
      eu: "Gure zerrendak LAB sindikatuaren kanpoko babes juridikoa du, eta horrek independentzia osoz jarduteko eta lege-aholkularitza espezializatua izateko aukera ematen digu. Horrek laguntza eta segurtasuna bermatzen ditu prozesu guztietan, baita prestakuntza eta laguntza aditua lan-negoziazioan, eskubideen defentsan eta gatazken ebazpenean ere, langileak modu sendo eta arduratsuan ordezkatzeko gure gaitasuna indartuz.",
    ...
    items: [
      {
        ...
        a: {
          ...
          en: "According to the Workers' Statute (Art. 63): The works council is the representative and collegiate body of all workers in the company or workplace for the defense of their interests, established in each workplace with a census of 50 or more workers.\n\nIn other words, it is a body representing the workers and made up exclusively of workers from the centre, which acts as an official two-way communication channel between the centre's management and the research, technical, and management staff.",
        },
      },
      {
        q: {
          ...
          en: "What is the purpose of a works council?",
        },
        a: {
          ...
          en: "The works council's mission is to ensure the well-being of the workers at the centre, for which management must provide information from time to time, such as the company's financial situation and the forecast for new contracts.\n\nThe council, which represents all the staff, has the power to negotiate collectively with management to reach agreements (which may affect schedules, work-life balance, homeworking, etc.). In addition, if necessary, the council participates in the negotiation of its own collective agreements.\n\nThe council must also monitor compliance with the collective agreement and other laws and participate in occupational risk prevention plans, equal treatment and opportunity plans, etc.\n\nOn the other hand, the centre's management must inform the council of all decisions that could lead to significant changes in the organization of work and employment contracts. The council has the right to issue a report prior to the implementation of any action affecting the following issues:\n\n- Restructuring and termination of staff.\n- Reduction of working hours.\n- Total or partial relocation.\n- Merger, acquisition, or modification of the company's legal status.\n- Professional training plans.\n- Implementation and review of work organisation and control systems, analysis of schedules, establishment of bonus and incentive systems, and job evaluation.\n\nFollowing the report, the council may meet with the centre's management to obtain a justified response to its report and to compare points of view and opinions in order to reach an agreement.\n\nMore information in the Workers' Statute (Art. 64)",
        },
      },
      {
        q: {
          ...
          en: "What does a works council bring to Vicomtech?",
        },
        a: {
          ...
          en: "In a technological and scientific environment such as Vicomtech, where talent is the main asset, a works council can bring strategic value. As a two-way communication channel, the council can convey feedback from staff directly to management, as well as propose solutions and negotiate agreements to improve overall well-being.\n\nOur candidacy advocates for transparent communication that helps maintain a working environment of trust and flexibility.",
        },
      },
      {
        q: {
          ...
          en: "How many people are on the works council?",
        },
        a: {
          ...
          en: "The number of people on the council depends on the number of staff at the workplace. In our case, in San Sebastian, according to the Workers' Statute (Art. 66), there should be a council made up of nine employees.",
        },
      },
      {
        q: {
          ...
          en: "Why are we holding works council elections at Vicomtech right now?",
        },
        a: {
          ...
          en: "The Workers' Statute (Art. 63) establishes that all workplaces with over 50 employees must have a works council, but the administration does not automatically organise them. It is a process that must be driven by a group of candidates with sufficient support from the workforce to form the council according to the size of the workplace. The process can be carried out with the support of a trade union (such as LAB) or without it. In the case of candidacies without the support of a trade union, in addition to the people who make up the candidacy, three endorsers are required for each person on the candidacy.\n\nThe process was initiated by the Vicomtech workforce. A diverse group of professionals at the centre identified the need for a collective voice to manage our stability and rights. It was our decision to submit our candidacy and call for works council elections at Vicomtech. We selected LAB as our support platform to ensure that this process has the necessary legal support to negotiate with management.",
        },
      },
      {
        q: {
          ...
          en: "Why are elections only held for San Sebastian and not for both centres (San Sebastian and Bilbao)?",
        },
        a: {
          ...
          en: "The Workers' Statute is very strict in this regard: each workplace with 50 or more employees may set up its own works council (Art. 63 of the Workers' Statute).\n\nIn the event that there are different workplaces with less than 50 employees, and the total number of employees exceeds 50, a joint works council may be established if those workplaces are located in the same province or neighbouring municipalities.\n\nIn the case of Bilbao, as it is a different province, a joint council with Donostia could not be set up. That being said, it is the wish of this candidacy that all the improvements negotiated by the San Sebastian council be applied in Bilbao in an equal manner.",
        },
      },
      {
        q: {
          ...
          en: "Why run for office with union backing, and how does this guarantee our autonomy?",
        },
        a: {
          ...
          en: "The decision to run with union backing is part of a strategy of professionalisation and guarantees. As professionals in the field of research and management, we are aware that labour law and collective negotiation require specialised technical support. Having the support of the LAB union provides first-rate legal, technical and training support, a formula that is already successfully working in other BRTA centres such as Tekniker, Azti and Tecnalia. This backing does not detract from independence, but rather reinforces it: having our own resources allows us to negotiate with Vicomtech's management on an equal footing, with complete autonomy and without depending on the centre's resources or will.\n\nIt is essential to emphasise that our candidacy is plural and diverse, made up of people with very different backgrounds and origins — from the Basque Country to Asturias, Zaragoza, Málaga and Madrid — who share an exclusively professional goal. The intention of this candidacy is to focus on improving working conditions at Vicomtech (salaries, work-life balance, flexibility), ensuring that every decision is always taken in favour of the centre's employees.",
        },
      },
      {
        q: {
          ...
          en: "Are the members of this candidacy familiar with the agreement in force at Vicomtech?",
        },
        a: {
          ...
          en: "The members of this list have extensive knowledge of the agreement (14th State Collective Agreement for University Education and Research Centres), based on technical analysis and, above all, on tangible results for the workforce. It is a fact that the members of this list have worked effectively to ensure compliance.\n\nThanks to this analysis, members of this list, together with other colleagues, managed to consolidate the 15-minute break as effective working time in accordance with Article 33 and ensure the enjoyment of the third day off set out in Article 35, milestones that until recently were not taken into account in the day-to-day running of the company.\n\nThat same analysis allowed us to detect a critical point during the discussions about the transfer to MUBIL. A member of our list warned HR about the application of Article 46, an aspect that had gone unnoticed until then and which regulates changes of physical location when there are objective deficiencies in public transport and establishes that in certain cases a transport bonus may be established through negotiation.",
        },
      },
    ],
  },
  footer: {
    rights: {
      es: "Candidatura para comite de empresa — Respaldada por LAB",
      eu: "Langile-batzorderako hautagaitza — LABek babestua",
      en: "Application for works council — Backed by LAB",
    },
  },
} as const;
