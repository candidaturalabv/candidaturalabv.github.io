    ...
    items: [
      {
        ...
        a: {
          ...
          eu: 'Langileen Estatutuaren arabera (63. art.): Enpresa batzordea enpresako edo lantokiko langile guztien ordezkaritza organo kolegiatu bat da, haien interesak defendatzeko, 50 langile edo gehiagoko zentsu duen lantoki bakoitzean eratuz.\n\nHau da, langileen ordezkaritza organoa da, soilik zentroko langileek osatua, zuzendaritzaren eta ikerketa, teknika eta kudeaketa pertsonalaren arteko komunikazio bide ofizial eta norabide bikoitzekoa.',
      ...
      },
      {
        q: {
          ...
          eu: 'Zertarako balio du enpresa batzorde batek?',
        ...
        a: {
          ...
          eu: 'Enpresa batzordearen eginkizuna zentroko langile guztien ongizainaz arduratzea da. Horretarako, zuzendaritzak aldian-aldian informazioa eman behar du, hala nola enpresaren egoera ekonomikoa eta kontratu berrien aurreikuspena.\n\nBatzordeak, zentroko langileen ordezkaritzan, negoziazio kolektiborako gaitasuna du zuzendaritzarekin, enpresa akordioak lortzeko (ordutegiak, kontziliazioa, telelana, etab.). Gainera, batzordeak hitzarmen kolektibo propioen negoziaketan parte hartzen du.',
      ...
      },
      {
        q: {
          ...
          eu: 'Zer ekartzen dio enpresa batzorde batek gure zentroari?',
        ...
        a: {
          ...
          eu: 'Gure bezalako ingurune teknologiko eta zientifiko batean, non talentua aktibo nagusia den, enpresa batzorde batek balio estrategikoak ekar ditzake. Norabide bikoitzeko komunikazio bide bat izanik, batzordeak langileen feedbacka zuzenean zuzendaritzara helarazi dezake, baita irtenbideak proposatu eta ongizate orokorra hobetzeko akordioak negoziatu ere.',
      ...
      },
      {
        q: {
          ...
          eu: 'Zenbat pertsonak osatzen dute enpresa batzordea?',
        ...
        a: {
          ...
          eu: 'Batzordea osatzen duten pertsona kopurua lantokiko langile kopuruaren araberakoa da. Gure kasuan eta Langileen Estatutuaren arabera (66. art.), 9 langilek osatutako batzordea dagokigu.',
      ...
      },
      {
        q: {
          ...
          eu: 'Zergatik ditugu enpresa batzorderako hauteskundeak orain?',
        ...
        a: {
          ...
          eu: 'Langileen Estatutuak (63. art.) ezartzen du 50 pertsona baino gehiagoko lantoki guztiek batzordea izan behar dutela, baina administrazioak ez du ofizioz antolatzen. Hautagaitza batek bultzatu behar duen prozesua da.\n\nProzesua plantilla bertatik sortu da. Zentroko profesional talde anitz batek ahots kolektibo baten beharra identifikatu dugu gure egonkortasuna eta eskubideak kudeatzeko. LAB hautatu dugu laguntza plataforma gisa.',
      ...
      },
      {
        q: {
          ...
          eu: 'Zergatik hauteskundeak Donostiarako soilik eta ez bi zentroetarako?',
        ...
        a: {
          ...
          eu: 'Langileen Estatutua oso zorrotza da alderdi honetan: 50 pertsona edo gehiagoko zentsu duen lantoki bakoitzak bere enpresa batzordea eratu dezake (63. art.).\n\nBilboren kasuan, probintzia desberdina izanik, ezin izango litzateke Donostiarekin batzorde bateratua eratu. Hala ere, hautagaitza honen nahia da Donostiako batzordeak negoziatutako hobekuntza guztiak Bilbon ere modu baliokidean aplikatzea.',
      ...
      },
      {
        q: {
          ...
          eu: 'Zergatik hautagaitza sindikatu babesarekin eta nola bermatzen du honek plantillaren autonomia?',
        ...
        a: {
          ...
          eu: 'Sindikatuaren babesarekin aurkeztea profesionalizazio eta bermeen estrategia bati erantzuten dio. LAB sindikatuaren laguntza izateak lehen mailako laguntza juridikoa, teknikoa eta formatiboa eskaintzen du. Babes honek ez du independentzia kentzen, sendotzen baizik.\n\nFuntsezkoa da azpimarratzea gure hautagaitza plurala eta anitza dela, ibilbide eta jatorri oso desberdinetako pertsonek osatua, helburu profesional esklusiboa partekatzen dutenak.',
      ...
      },
      {
        q: {
          ...
          eu: 'Hautagaitza honetako kideek ezagutzen al dute aplikazio hitzarmena?',
        ...
        a: {
          ...
          eu: 'Zerrenda honetako kideok hitzarmenaren ezagutza zabala dugu (XIV Estatuko esparruko hitzarmen kolektiboa unibertsitate hezkuntza eta ikerketa zentroetarako), analisi teknikoan eta, batez ere, plantillarentzako emaitza ukigarrietan oinarritua.\n\nAnalisi lan horri esker, zerrenda honetako kideok, beste lankide batzuekin batera, 15 minutuko atsedena lan denbora efektibo gisa finkatzea lortu genuen 33. Artikuluaren arabera, eta 35. Artikuluan jasotako hirugarren day off-aren gozamena ziurtatu.',
